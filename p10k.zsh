# Generated by Powerlevel10k configuration wizard on 2021-08-12 at 18:28 CEST.
...
# 12h time, round separators, sharp heads, flat tails, 2 lines, solid, right frame,
...
() {
  ...
  function prompt_example() { #statements }
    local idx=$(python3 ~/dotfiles/lunar_calendar.py)
    # echo $idx
    local moon_text=('New Moon ' 'Waxing Crescent ' 'First Quarter ' 'Waxing Gibbous ' 'Full Moon ' 'Waning Gibbous ' 'Last Quarter ' 'Waning Crescent ' )
    local moons=( '🌑' '🌒' '🌓' '🌔' '🌕' '🌖' '🌗' '🌘' )
    # p10k segment -f 208 -i '⭐' -t 'hello, %n'
    p10k segment -f 208 -s ${idx} -t ${moons_text[$idx]} 
  }

  function prompt_moons() { #statements }
    local idx=$(python3 ~/dotfiles/lunar_calendar.py)
    local moonText=('New Moon ' 'Waxing Crescent ' 'First Quarter ' 'Waxing Gibbous ' 'Full Moon ' 'Waning Gibbous ' 'Last Quarter ' 'Waning Crescent ' )
    local moons=( '🌑' '🌒' '🌓' '🌔' '🌕' '🌖' '🌗' '🌘' )
    # p10k segment -f 208 -i '⭐' -t 'hello, %n'
    p10k segment -f 208 -i "${moons[idx]}" -t "${moonText[idx]}" 
  }
